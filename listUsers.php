...
echo "<div id='tabela' style='float:left' width='66%'><table id='usersList'><thead><tr><th id='sort' width='50%'>Nome</th><th id='sort' width='30%'>Cidade</th><th></th></tr></thead><tbody>";
